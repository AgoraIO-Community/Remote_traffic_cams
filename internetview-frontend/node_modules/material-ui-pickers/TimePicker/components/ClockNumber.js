...
var ClockNumber = /** @class */ (function (_super) {
    ...
    ClockNumber.prototype.render = function () {
        ...
        var className = classnames_1.default(classes.clockNumber, (_a = {},
            _a[classes.selected] = selected,
            _a));
        return (React.createElement(Typography_1.default, { variant: isInner ? 'body1' : 'subtitle1', component: "span", className: className, style: this.getTransformStyle(index) }, label));
    };
