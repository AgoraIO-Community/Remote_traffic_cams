...
var ClockPointer = /** @class */ (function (_super) {
    ...
    ClockPointer.prototype.render = function () {
        ...
        return (React.createElement("div", { style: this.getAngleStyle(), className: classnames_1.default(classes.pointer, (_a = {},
                _a[classes.animateTransform] = this.state.toAnimateTransform,
                _a)) },
            React.createElement("div", { className: classnames_1.default(classes.thumb, (_b = {},
