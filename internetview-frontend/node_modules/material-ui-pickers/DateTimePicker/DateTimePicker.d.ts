...
declare const _default: React.FunctionComponent<Pick<DateTimePickerProps, "onChange" | "ampm" | "initialFocusedDate" | "date" | "minDate" | "disablePast" | "disableFuture" | "maxDate" | "leftArrowIcon" | "rightArrowIcon" | "renderDay" | "allowKeyboardControl" | "shouldDisableDate" | "animateYearScrolling" | "showTabs" | "dateRangeIcon" | "timeIcon" | "autoSubmit" | "openTo" | "ViewContainerComponent">>;
